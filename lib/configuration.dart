...
final bool waitForBackend = false;

final String backendServerUrl = "http://localhost:8090";
final String addProductUrl = "/product/add";
final String createShopUrl = "/shop/create";

//Informatique information//

final String informatiqueName = "Informatique";
final String informatiqueUrl = "www.informatique.nl";

//Informatique product pages//

final List informatiqueDiskUrls = [
...
final String alternateUrl = "www.alternate.nl";

//Alternate product pages//

final List alternateDiskUrls = [
...
final List alternateProcessorUrls = [
  "https://www.alternate.nl/Processoren/Desktop/Alle-processoren?size=500"
];

final List alternatePowerSupplyUnitUrls = [
...
final List alternateVideocardUrls = [
