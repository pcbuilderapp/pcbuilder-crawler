...
class Informacrawl {
  ...
  static Future crawlInformatique() async {
    try {
      ...
      psuTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=171&view=6&&sort=pop&pl=196", new InformatiquePowerSupplyUnitParser());
      psus.addAll(psuTmp);
      ...
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/pc_componenten/moederborden/socket_2011_(intel)/c001-h033-g670/", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=744&view=6&&sort=pop&pl=272", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=699&view=6&&sort=pop&pl=77", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=713&view=6&&sort=pop&pl=26", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/pc_componenten/moederborden/socket_am1_(amd)/c001-h033-g717/", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=655&view=6&&sort=pop&pl=30", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/pc_componenten/moederborden/socket_fm2_(amd)/c001-h033-g686/", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      motherboardsTmp = await Crawler.crawl("http://www.informatique.nl/pc_componenten/moederborden/on-board_cpu/c001-h033-g558/", new InformatiqueMotherboardParser());
      motherboards.addAll(motherboardsTmp);
      ...
      videocardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=166&view=6&&sort=pop&pl=211", new InformatiqueVideoCardParser());
      videocards.addAll(videocardsTmp);
      videocardsTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=188&view=6&&sort=pop&pl=53", new InformatiqueVideoCardParser());
      videocards.addAll(videocardsTmp);
      ...
      pcCasesTmp = await Crawler.crawl("http://www.informatique.nl/?m=usl&g=004&view=6&&sort=pop&pl=547", new InformatiqueCaseParser());
